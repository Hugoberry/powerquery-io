...
Vráti zoznam hodnôt `datetimezone` s veľkosťou `count`, počnúc od hodnoty `start`. Daný prírastok `step` je hodnota `duration`, ktorá sa pripočítava ku každej hodnote.
