...
Udáva, či sa zadaný záznam `row` zobrazuje ako riadok v tabuľke `table`. Možno stanoviť voliteľný parameter `equationCriteria` a kontrolovať tak porovnanie medzi riadkami tabuľky.
