...
Pridá stĺpec s názvom `newColumnName` do tabuľky `table`. Hodnoty pre tento stĺpec sa vypočítajú pomocou zadanej funkcie výberu `columnGenerator`, pričom každý riadok sa použije ako vstup.
