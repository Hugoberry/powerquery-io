...
Uskutočňovanie volania do rozhrania Stripe API na adrese https://api.stripe.com/v1/`method` so záznamom `additionalParameters`, ktorý predstavuje dodatočné parametre, a zoznamom `ColumnNames` s očakávanými názvami stĺpcov. Používa sa Stripe verzie 2015-10-16.
