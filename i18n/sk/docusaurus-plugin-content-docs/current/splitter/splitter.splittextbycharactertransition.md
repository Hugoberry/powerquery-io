...
Vráti funkciu, ktorá rozdelí text na zoznam textu podľa prechodu z jedného druhu znaku na iný. Parametrami `before` a `after` môže byť buď zoznam znakov, alebo funkcia, ktorá použije znak a vráti hodnotu pravda alebo nepravda.
