...
추가 매개 변수로 전달된 레코드 `additionalParameters`와 예상되는 열 이름 `ColumnNames` 목록을 포함하여 https://api.stripe.com/v1/`method`에서 Stripe API를 호출합니다. Stripe Version 2015-10-16이 사용됩니다.
