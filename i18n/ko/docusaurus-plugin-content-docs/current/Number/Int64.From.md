...
### Example #2 
&lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;를 사용하여 &lt;code&gt;&#34;4.5&#34;&lt;/code&gt;의 64비트 정수 &lt;code&gt;number&lt;/code&gt; 값을 가져옵니다.
```powerquery
