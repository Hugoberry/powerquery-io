...
Vrne tabelo tabel in pogledov SQL iz zbirke podatkov Teradata.
...
Vrne tabelo s tabelami in pogledi SQL iz zbirke podatkov Teradata v strežniku `server`. S strežnikom lahko izbirno določite vrata, ki jih ločite z dvopičjem. Navedete lahko izbirni parameter zapisa `options`, s katerim nadzorujete te možnosti:
