...
### Example #1 
Poiščite 8-bitno celoštevilsko vrednost &lt;code&gt;number&lt;/code&gt; za &lt;code&gt;&#34;4&#34;&lt;/code&gt;.
```powerquery
Byte.From("4")
```
...
### Example #2 
Poiščite 8-bitno celoštevilsko vrednost &lt;code&gt;number&lt;/code&gt; za &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; z načinom zaokroževanja &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
