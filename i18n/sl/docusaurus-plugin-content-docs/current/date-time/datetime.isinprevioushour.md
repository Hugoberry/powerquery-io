...
Označuje, ali se navedena vrednost za"datetime"`dateTime` pojavi v prejšnji uri, kot je določeno s trenutnim datumom in uro v sistemu. Rezultat te funkcije je"false", če navedete vrednost, ki se pojavi v trenutni uri.
