...
Vrne prvi element na seznamu `list` ali izbirno privzeto vrednost, `defaultValue`, če je seznam prazen. Če je seznam prazen in privzeta vrednost ni določena, funkcija vrne `null`.
