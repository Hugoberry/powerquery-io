...
Označuje, ali so vsi navedeni zapisi na seznamu zapisov `rows` prikazani kot vrstice v `table`. Določite lahko izbirni parameter `equationCriteria` za nadzor primerjave med vrsticami tabele.
