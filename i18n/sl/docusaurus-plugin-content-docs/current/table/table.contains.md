...
Označuje, ali je navedeni zapis, `row`, prikazan kot vrstica v `table`. Določite lahko izbirni parameter `equationCriteria` za nadzor primerjave med vrsticami tabele.
