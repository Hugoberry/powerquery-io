...
Ustvari tabelo vrste `columns` iz seznama `lists`, ki vsebuje ugnezdene sezname z imeni stolpcev in vrednostmi. Če imajo nekateri stolpci več vrednosti kot drugi, bodo manjkajoče vrednosti napolnjene s privzeto vrednostjo"null", če stolpci lahko imajo ničelno vrednost.
