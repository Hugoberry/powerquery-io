...
Doda stolpec z imenom `newColumnName` v tabelo `table`. Vrednosti za stolpec se izračunajo z določeno funkcijo izbire `columnGenerator`, pri čemer vsaka vrstica predstavlja vnos.
