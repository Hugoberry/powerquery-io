...
Санның таңбасы бойынша `number` дөңгелектеудің нәтижесін қайтарады. Бұл функция оң сандарды жоғары қарай және теріс сандарды төмен қарай дөңгелектейді. Егер `digits` көрсетілсе, `number` саны ондық санның `digits` санына дөңгелектеледі.
