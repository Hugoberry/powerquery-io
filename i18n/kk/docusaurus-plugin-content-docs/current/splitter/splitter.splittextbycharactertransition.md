...
Таңбаның бір түрінен екіншісіне өтуге сәйкес мәтінді мәтіндер тізіміне бөлетін функцияны қайтарады. `before` және `after` параметрлері таңбалар тізімі немесе таңбаны алатын және шын/жалған мәнін қайтаратын функция болуы мүмкін.
