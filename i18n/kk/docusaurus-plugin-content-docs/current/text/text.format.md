...
Тізімнен немесе жазбадан `formatString` пішім жолына `arguments` қолдану арқылы жасалған пішімделген мәтінді қайтарады. Сонымен қатар қосымша `culture` берілуі мүмкін (мысалы, "en-US").
