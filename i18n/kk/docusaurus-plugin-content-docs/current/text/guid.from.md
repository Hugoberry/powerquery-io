...
Берілген `value` арқылы `Guid.Type` мәнін қайтарады. Егер берілген `value` `null` болса, `Guid.From` `null` мәнін қайтарады. Берілген `value` пішімі қаншалықты жарамды екенін анықтау үшін тексеріс жүргізіледі. Жарамды пішімдер мысалдарда берілген.
