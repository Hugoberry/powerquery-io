...
https://api.stripe.com/v1/`method` мекенжайында қосымша параметрлер ретінде `қосымша параметрлер` жазбасы бар және күтілген арна атауларының `Баған атаулары` тізімі бар Stripe API интерфейсіне қоңырау соғады. Stripe бағдарламасының 2015-10-16 нұсқасы пайдаланылады.
