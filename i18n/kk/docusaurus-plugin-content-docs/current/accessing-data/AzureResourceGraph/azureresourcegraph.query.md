...
Көріңіз: https://learn.microsoft.com/azure/governance/resource-graph/samples/starter?tabs=azure-cli


## Examples

### Example #1
Пайдаланушының “ресурстар” сұрауының нәтижелері бар кестені қайтару
```powerquery
