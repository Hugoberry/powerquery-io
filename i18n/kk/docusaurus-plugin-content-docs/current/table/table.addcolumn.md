...
`table` кестесіне `newColumnName` атты бағанды қосады. Бағанның мәндері көрсетілген `columnGenerator` таңдау функциясын пайдаланып, әр жол кіріс ретінде алынып есептеледі.
