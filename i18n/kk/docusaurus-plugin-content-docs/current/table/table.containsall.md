...
`rows` жазбалар тізіміндегі барлық көрсетілген жазбалар `table` ішінде жолдар ретінде пайда болатынын көрсетеді. Кестенің жолдарын салыстыруды басқару үшін `equationCriteria` міндетті емес параметрін көрсетуге болады.
