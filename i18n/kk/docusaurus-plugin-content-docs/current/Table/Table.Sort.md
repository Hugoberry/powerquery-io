...
<code>table</code> бір немесе бірнеше баған атауын және \{ \{ col1, comparisonCriteria }, \{col2} } түріндегі міндетті емес <code>comparisonCriteria</code> пайдаланып сұрыптайды.
