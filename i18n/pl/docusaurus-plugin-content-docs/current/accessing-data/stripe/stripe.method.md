...
Nawiązuje połączenie z interfejsem API usługi Stripe pod adresem https://api.stripe.com/v1/`method` z rekordem `additionalParameters` przekazanym jako parametry dodatkowe i listą `ColumnNames` oczekiwanych nazw kolumn. Stosowana wersja usługi Stripe to 2015-10-16.
