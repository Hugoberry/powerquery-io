...
Zwraca tabelę zawierającą wiersz odpowiadający każdemu elementowi listy znalezionemu na określonej liście programu SharePoint `url`. Każdy wiersz zawiera właściwości listy. Parametr `options` pozwala określić następujące opcje:
