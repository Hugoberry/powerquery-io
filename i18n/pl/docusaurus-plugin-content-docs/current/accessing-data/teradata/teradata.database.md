...
Zwraca tabelę tabel i widoków SQL z bazy danych programu Teradata.
...
Zwraca tabelę zawierającą tabele i widoki SQL dostępne w bazie danych Teradata na serwerze `server`. Opcjonalnie można określić port serwera oddzielony dwukropkiem. Za pomocą opcjonalnego parametru rekordu `options` można określić następujące opcje:
