...
### Example #2 
Pobiera 8-bitową liczbę całkowitą &lt;code&gt;number&lt;/code&gt; dla wartości &lt;code&gt;&#34;4.5&#34;&lt;/code&gt;, używając trybu zaokrąglania &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
