...
Wskazuje, czy tabela `table` zawiera określone kolumny (`columns`). Zwraca wartość `true`, jeśli tabela zawiera te kolumny, w przeciwnym razie zwraca wartość `false`.
