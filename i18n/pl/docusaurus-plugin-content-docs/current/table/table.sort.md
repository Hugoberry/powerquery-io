...
Sortuje tabelę `table` przy użyciu listy zawierającej co najmniej jedną nazwę kolumny oraz opcjonalnego parametru `comparisonCriteria` w formie \{ \{ col1, comparisonCriteria \}, \{col2\} \}.
