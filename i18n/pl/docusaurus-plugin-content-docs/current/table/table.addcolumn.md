...
Dodaje kolumnę o nazwie `newColumnName` do tabeli `table`. Wartości kolumny są obliczane przy użyciu określonej funkcji wyboru `columnGenerator` wykonywanej na każdym wierszu wejściowym.
