...
Zwraca listę `count` z wartościami typu `duration`, rozpoczynając od wartości `start` i używając jako przyrostu danej wartości typu `duration` podanej w parametrze `step`.
