...
Indica se il valore datetime specificato `dateTime` rientra nel numero di settimane successivo, come determinato dalla data e dall'ora correnti del sistema. Questa funzione restituirà false se viene passato un valore che rientra nella settimana corrente.
