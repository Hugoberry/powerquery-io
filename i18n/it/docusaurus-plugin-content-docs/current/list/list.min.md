...
Restituisce l'elemento minimo dell'elenco `list` o il valore predefinito facoltativo `default`, se l'elenco è vuoto. È possibile specificare un valore facoltativo comparisonCriteria `comparisonCriteria` per determinare come confrontare gli elementi nell'elenco. Se questo parametro è Null, si usa l'operatore di confronto predefinito.
