...
Restituisce un elenco di valori `datetime` di dimensione `count`, a partire da `start`. L'incremento specificato `step` è un valore `duration` che viene aggiunto a ogni valore.
