...
Restituisce il contenuto del BLOB disponibile all'URL `url` da un insieme di credenziali di archiviazione di Azure. È possibile specificare `options` per controllare le opzioni seguenti:
