...
Decodifica dados de um formato binário em texto.
...
-   `encoding`: (Opcional) A codificação usada para converter o binário em texto. Use `BinaryEncoding.Type` para especificar o tipo de codificação. Se esse valor não for especificado, o valor padrão será `BinaryEncoding.Utf8`.
