...
Retorna uma lista de valores `datetimezone` de tamanho `count`, iniciando em `start`. O incremento especificado, `step`, é um valor `duration` adicionado a cada valor.
