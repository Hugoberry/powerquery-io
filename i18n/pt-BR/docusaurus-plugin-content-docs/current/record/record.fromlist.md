...
Retorna um registro dado um `list` de valores de campo e um conjunto de campos. O `fields` pode ser especificado por uma lista de valores de texto ou por um tipo de registro. Um erro será gerado se os campos não forem exclusivos.
