...
Retorna uma tabela de tabelas e exibições SQL do banco de dados Teradata.
...
Retorna uma tabela de tabelas e exibições SQL disponíveis em um banco de dados Teradata, no servidor `server`. Como alternativa, a porta pode ser especificada com o servidor, separada por uma vírgula. Um parâmetro de registro opcional, `options`, pode ser especificado para controlar as seguintes opções:
