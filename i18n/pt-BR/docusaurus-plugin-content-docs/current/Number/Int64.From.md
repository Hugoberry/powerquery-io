...
### Example #2 
Obter o valor &lt;code&gt;número&lt;/code&gt; inteiro de 64 bits de &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; usando &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
