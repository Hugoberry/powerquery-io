...
### Example #1 
Obtenha o valor de &lt;code&gt;number&lt;/code&gt; inteiro de 8 bits assinado de &lt;code&gt;&#34;4&#34;&lt;/code&gt;.
```powerquery
Int8.From("4")
```
...
### Example #2 
Obtenha o valor de &lt;code&gt;number&lt;/code&gt; inteiro de 8 bits assinado de &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; usando &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
