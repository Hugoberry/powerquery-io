...
Remove `count` de linhas desde o início da `table`, começando na `offset` especificada. Uma contagem padrão 1 será usada se o parâmetro `count` não for fornecido.
