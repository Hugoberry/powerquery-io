...
Indikerar om det angivna datetime-värde `dateTime` infaller under nästa timme enligt systemets aktuella datum och tid. Observera att den här funktionen returnerar false när den skickas ett värde som infaller den aktuella timmen.
