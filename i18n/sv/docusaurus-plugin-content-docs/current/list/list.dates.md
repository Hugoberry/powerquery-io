...
Returnerar en lista med `date`\-värden med storleken `count` med början från `start`. Den angivna ökningen, `step`, är ett `duration`\-värde som läggs till för varje värde.
