...
Returnerar en tabell med SQL-tabeller och vyer som är tillgängliga i en Sybase-databas.
...
Returnerar en tabell med SQL-tabeller och vyer som är tillgängliga i en Sybase-databas på servern `server` i databasinstansen `database`. Du kan också välja att ange porten med servern, avgränsad med ett kolon. En valfri postparameter `options`, kan anges för att styra följande alternativ:
