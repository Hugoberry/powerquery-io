...
Anropar Stripe-API:et på https://api.stripe.com/v1/`method`, med den alternativa posten `additionalParameters` överförd som extra parametrar och listan `ColumnNames` med förväntade kolumnnamn. Stripe-version 2015-10-16 används.
