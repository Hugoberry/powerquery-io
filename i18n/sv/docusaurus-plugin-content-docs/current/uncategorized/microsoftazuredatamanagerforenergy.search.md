...
Frågor efter poster i Microsoft Azure Data Manager för Energi-instansen


## Examples

### Example #1
Returnerar en post som innehåller antalet poster som uppfyller frågan och en tabell med poster som eventuellt har begränsats av gränsparametern
```powerquery
...
Result: 
```powerquery
En navigeringstabell som innehåller [Count = 4947, Records = #table({""Records""}, {{[...]}, {[...]}})]
```
