...
Indikerar om angivet datetime-värde `dateTime` infaller under det föregående antalet år enligt systemets aktuella datum och tid. Observera att den här funktionen returnerar falskt när den skickas ett värde som infaller inom det aktuella året.
