...
Indikerar om angivet datetime-värde `dateTime` infaller under föregående vecka enligt systemets aktuella datum och tid. Observera att den här funktionen returnerar falskt om den skickas ett värde som infaller inom den aktuella veckan.
