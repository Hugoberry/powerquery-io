...
Anger om `table` innehåller den eller de angivna kolumnerna, `columns`. Returnerar `true` om tabellen innehåller kolumnen eller kolumnerna. Annars returneras `false`.
