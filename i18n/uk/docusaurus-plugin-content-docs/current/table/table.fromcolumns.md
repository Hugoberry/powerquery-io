...
Створює таблицю типу `columns` зі списку `lists`, що містить вкладені списки з іменами та значеннями стовпців. Якщо деякі стовпці мають більше значень, ніж інші, відсутні значення заповнюватимуться стандартним (Null-значенням, якщо стовпці це допускають).
