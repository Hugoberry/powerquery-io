...
Додає стовпець з іменем `newColumnName` у таблицю `table`. Значення для стовпця обчислюються з використанням указаної функції вибору `columnGenerator`, причому кожний рядок розглядається як вхідні дані.
