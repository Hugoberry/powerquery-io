...
Повертає таблицю із зазначеного `table`, куди розповсюджується значення наступної клітинки до верхніх клітинок із нульовим значенням у зазначеному `columns`.
