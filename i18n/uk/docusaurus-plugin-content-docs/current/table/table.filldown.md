...
Повертає таблицю із зазначеного `table`, куди розповсюджується значення попередньої клітинки до нижніх клітинок із нульовим значенням у зазначеному `columns`.
