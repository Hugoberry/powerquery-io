...
Визначає, чи відображається вказаний запис, `row`, у `table` у вигляді рядка. Можна вказати додатковий параметр `equationCriteria` для керування порівнянням рядків таблиці.
