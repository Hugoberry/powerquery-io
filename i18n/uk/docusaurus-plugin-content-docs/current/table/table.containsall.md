...
Визначає, чи всі вказані записи у списку записів `rows` відображаються в `table` у вигляді рядків. Можна вказати додатковий параметр `equationCriteria` для керування порівнянням рядків таблиці.
