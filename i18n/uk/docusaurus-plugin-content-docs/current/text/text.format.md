...
Повертає форматований текст, створений за допомогою застосування параметра `arguments` зі списку або запису до рядка формату `formatString`. Крім того, можна вказати необов’язковий параметр `culture` (наприклад, "uk-UA").
