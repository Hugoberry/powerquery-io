...
Змінює інформацію про часовий пояс значення дати й часу з часовим поясом `dateTimeZone` на інформацію про місцевий часовий пояс. Якщо `dateTimeZone` не має компонента часового поясу, додається інформація про місцевий часовий пояс.
