...
### Example #1
Konvertér `"2010-12-31T01:30:00"` til en værdi af typen datetime.
```powerquery
...
### Example #2
Konvertér `"2010-12-31T01:30:00.121212"` til en værdi af typen datetime.
```powerquery
...
### Example #4
Konvertér `"20101231T013000"` til en værdi af typen datetime.
```powerquery
