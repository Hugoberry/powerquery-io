...
Tilføjer en ny kolonne `newColumnName` til `table` med repræsentative værdier for `columnName`. Repræsentanterne hentes sammen med fuzzily-matchende værdier i `columnName` for hver række.
