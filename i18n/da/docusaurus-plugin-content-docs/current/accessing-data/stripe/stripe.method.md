...
Foretager et opkald til Stripe-API'en på https://api.stripe.com/v1/`metode`, hvor posten `additionalParameters` er godkendt som yderligere parametre og listen `ColumnNames` viser de forventede kolonnenavne. Stripe-version 2015-10-16 anvendes.
