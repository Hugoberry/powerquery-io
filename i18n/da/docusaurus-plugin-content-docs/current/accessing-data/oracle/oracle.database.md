...
Returnerer en tabel over SQL-tabeller og visninger fra Oracle Database.
...
Returnerer en tabel over SQL-tabeller og visninger fra Oracle Database på serveren `server`. Porten kan eventuelt være angivet med serveren, adskilt af et kolon. En valgfri parameter for post, `options`, kan være angivet for at kontrollere følgende indstillinger:
