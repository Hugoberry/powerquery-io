...
Returnerer en funktion, der opdeler tekst på en liste med tekst i overensstemmelse med en overgang fra én slags tegn til et andet. Parametrene `before` og `after` kan enten være en liste over tegn eller en funktion, som tager et tegn og returnerer true/false.
