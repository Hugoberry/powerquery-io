...
Angiver, om den anførte datetime-værdi `dateTime` er indtruffet i løbet af det forrige år, fastlagt i forhold til aktuel dato og aktuelt klokkeslæt i systemet. Bemærk, at denne funktion returnerer False, når den modtager en værdi, der indtræffer inden for det aktuelle år.
