...
Returnerer den eller de maksimale værdier på listen. Antallet af værdier, der skal returneres, eller en filterbetingelse skal angives.
...
### Example #1
Find de øverste 5 værdier på den angivne liste.
```powerquery
...
### Example #2
Find ordene med mere end 3 tegn.
```powerquery
List.MaxN(
...
### Example #3
Find de tre seneste datoer på en liste over tyske datoer.
```powerquery
let
