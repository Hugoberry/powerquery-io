...
Returnerer en liste over værdier af typen `datetime` i størrelsen `count` og med start ved `start`. Den angivne stigning, `step`, er en værdi af typen `duration`, der lægges til alle værdier.
