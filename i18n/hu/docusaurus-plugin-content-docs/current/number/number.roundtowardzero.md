...
A(z) `number` szám előjeltől függő kerekítésének eredményét adja vissza. Ez a függvény lefelé kerekíti a pozitív számokat, és felfelé kerekíti a negatív számokat. Ha meg van adva a(z) `digits` érték, a(z) `number` szám `digits` tizedesjegyre lesz kerekítve.
