...
Felvesz egy `newColumnName` nevű oszlopot a(z) `table` táblába. Az oszlop értékeinek kiszámítása a megadott `columnGenerator` kiválasztási függvénnyel történik, amely mindegyik sort megkapja bemenetként.
