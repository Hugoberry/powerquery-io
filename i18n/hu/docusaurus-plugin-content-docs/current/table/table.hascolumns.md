...
Azt jelzi, hogy a(z) `table` tábla tartalmazza-e a megadott `columns` oszlopo(ka)t. `true` értéket ad vissza, ha a tábla tartalmazza az oszlopo(ka)t, egyébként `false` értéket ad vissza.
