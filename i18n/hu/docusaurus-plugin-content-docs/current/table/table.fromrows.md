...
Egy táblát hoz létre a(z) `rows` listából, ahol a lista egyes elemei belső listák, amelyek egyetlen sor oszlopértékeit tartalmazzák. A(z) `columns` elemhez megadható egy opcionális lista az oszlopnevekkel, egy táblatípus, vagy az oszlopok száma.
