...
`columns` típusú táblát hoz létre a(z) `lists` listából, amely beágyazott listákat tartalmaz az oszlopok nevével és értékeivel. Ha valamelyik oszlop több értéket tartalmaz a többinél, akkor a hiányzó értékek az alapértelmezett „null” értékkel lesznek feltöltve, ha az oszlopok nullázhatóak.
