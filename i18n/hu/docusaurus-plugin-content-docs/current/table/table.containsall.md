...
Azt jelzi, hogy a(z) `rows` rekordlistában az összes megadott rekord sorként szerepel-e a(z) `table` táblában. A választható `equationCriteria` paraméterrel határozható meg a tábla sorainak összehasonlítása.
