...
A bemeneti `absoluteUri` részeit adja vissza rekordként, amely egyebek között Scheme, Host, Port, Path, Query, Fragment, UserName és Password értékeket tartalmaz.
