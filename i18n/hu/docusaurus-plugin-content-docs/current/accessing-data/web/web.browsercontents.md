...
Visszaadja a megadott `url`HTML-jét egy webböngészőben megjelenített formában. Egy választható rekordparaméterrel (`options`) további tulajdonságok is megadhatók. A rekord a következő mezőket tartalmazhatja:
