...
Egy olyan összehasonlító függvényt ad vissza, amely a(z) `culture` és a(z) `ignoreCase` által megadott kis- és nagybetűk közötti megkülönböztetést használja összehasonlítások végrehajtásához.  
...
A(z) `ignoreCase` alapértelmezett értéke hamis. A(z) `culture` értékének a .NET-keretrendszer által támogatott területi beállítások egyikének kell lennie (például „en-US”).
