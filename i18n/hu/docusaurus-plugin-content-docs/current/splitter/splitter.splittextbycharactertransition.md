...
Visszaad egy függvényt, amely egy szöveglistára osztja fel a szövegeket az egyik karaktertípusról egy másikra való áttérés szerint. A(z) `before` és `after` paraméterek lehetnek karakterlisták, vagy olyan függvények, amelyek egy karaktert vesznek fel, és az igaz/hamis értéket adják vissza.
