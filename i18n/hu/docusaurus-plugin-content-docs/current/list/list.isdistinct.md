...
Logikai értéket ad vissza aszerint, hogy a(z) `list` listán vannak-e ismétlődő elemek; `true`, ha a lista minden eleme különbözik; `false`, ha vannak a listán ismétlődő értékek.
