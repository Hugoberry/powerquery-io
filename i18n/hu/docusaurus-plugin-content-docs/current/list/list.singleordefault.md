...
Ha csak egy elem szerepel a(z) `list` listán, a függvény azt az elemet adja vissza. Ha a lista üres, és nincs megadva egy nem kötelező `default` érték, a függvény nullértéket ad vissza. Ha több elem szerepel a listán, a függvény hibát ad vissza.
