...
Egy rekordot ad vissza a mezőértékeket tartalmazó megadott `list` és a mezők halmaza alapján. A(z) `fields` megadható szöveges értékek listájával vagy egy rekordtípussal. Hibaüzenet jelenik meg, ha a mezők nem egyediek.
