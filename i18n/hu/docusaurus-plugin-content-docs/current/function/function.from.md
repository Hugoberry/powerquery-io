...
Egy egyoperandusú függvényből (`function`) létrehoz egy `functionType` típusú új függvényt, amely listát készít az argumentumaiból, és továbbítja a(z) `function` felé.
