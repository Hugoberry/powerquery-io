...
Возвращает функцию, которая разделяет текст по спискам в соответствии с переходом одного типа символа в другой. Параметры `before` и `after` могут быть списком символов или функцией, которая принимает символ и возвращает значение True или False.
