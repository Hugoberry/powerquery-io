...
### Example #1 
Получить 32-разрядное целое значение &lt;code&gt;number&lt;/code&gt; для &lt;code&gt;&#34;4&#34;&lt;/code&gt;.
```powerquery
Int32.From("4")
```
...
### Example #2 
Получить 32-разрядное целое значение &lt;code&gt;number&lt;/code&gt; для &lt;code&gt;&#34;4.5&#34;&lt;/code&gt;, используя &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
