...
### Example #2 
使用 &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt; 取得 &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; 的 32 位元整數 &lt;code&gt;number&lt;/code&gt; 值。
```powerquery
