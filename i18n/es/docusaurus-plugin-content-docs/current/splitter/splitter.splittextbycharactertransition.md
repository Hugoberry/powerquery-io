...
Devuelve una función que divide texto en una lista de texto según una transición de un tipo de carácter a otro. Los parámetros `before` y `after` pueden ser una lista de caracteres o una función que toma un carácter y devuelve true o false.
