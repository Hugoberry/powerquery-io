...
Indica si el valor datetime `dateTime` proporcionado se produce durante el número anterior de semanas, como se determina por la hora y fecha actual del sistema. Tenga en cuenta que esta función devolverá un valor "false" al pasar un valor que se produzca en la semana actual.
