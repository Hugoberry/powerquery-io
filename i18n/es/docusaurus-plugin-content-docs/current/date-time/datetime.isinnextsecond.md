...
Indica si el valor datetime proporcionado `dateTime` se produce durante el segundo siguiente, determinado por la fecha y hora actual del sistema. Tenga en cuenta que esta función devuelve false cuando se pasa un valor que está dentro del segundo actual.
