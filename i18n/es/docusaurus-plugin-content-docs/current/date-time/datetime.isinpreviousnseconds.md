...
Indica si el valor datetime `dateTime` proporcionado se produce durante el número anterior de segundos, como se determina por la fecha y hora actual del sistema. Tenga en cuenta que esta función devolverá un valor "false" al pasar un valor que se produzca en el segundo actual.
