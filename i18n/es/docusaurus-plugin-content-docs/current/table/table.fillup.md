...
Devuelve una tabla del `table` especificado donde el valor de la celda siguiente se propaga a las celdas con valor NULL por encima de la `columns` especificada.
