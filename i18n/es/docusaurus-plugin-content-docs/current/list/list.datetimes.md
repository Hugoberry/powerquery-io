...
Devuelve una lista de valores `datetime` de tamaño `count`, a partir de `start`. El incremento especificado, `step`, es un valor `duration` que se agrega a cada valor.
