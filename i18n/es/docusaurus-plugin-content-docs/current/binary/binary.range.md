...
Devuelve un subconjunto del valor binario comenzando en el desplazamiento `binary`. Un parámetro opcional, `offset`, establece la longitud máxima del subconjunto.
