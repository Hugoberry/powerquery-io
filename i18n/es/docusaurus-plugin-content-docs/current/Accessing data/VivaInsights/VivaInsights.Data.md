...
Importe datos de atributos y métricas semanales de Workplace Analytics.


## Examples

### Example #1 
Devuelve una tabla con atributos visibles y métricas semanales para cada empleado medido en la partición.
```powerquery
