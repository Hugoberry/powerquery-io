...
Devuelve texto con formato que se crea por la aplicación de `arguments` de una lista o registro a una cadena de formato `formatString`. También se puede proporcionar un parámetro `culture` opcional (por ejemplo, "es-ES").
