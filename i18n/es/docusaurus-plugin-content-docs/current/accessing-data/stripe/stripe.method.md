...
Hace una llamada a la API de Stripe en https://api.stripe.com/v1/`method`, con el registro `additionalParameters` que se pasa como parámetros adicionales y la lista `ColumnNames` de nombres de columna esperados. Se usa Stripe versión 2015-10-16.
