...
Devuelve una tabla de tablas y vistas de SQL desde la base de datos de Teradata.
...
Devuelve una tabla de tablas y vistas SQL de la base de datos de Teradata en el servidor `server`. Es posible especificar el puerto con el servidor, separado por dos puntos. Se puede especificar un parámetro de registro opcional (`options`) para controlar las opciones siguientes:
