...
Pateikiama SQL lentelių ir peržiūrų iš „Teradata“ duomenų bazės lentelė.
...
Pateikiama SQL lentelių ir rodinių iš serveryje `server` esančios „Teradata“ duomenų bazės lentelė. Pasirinktinai kartu su serveriu galima nurodyti prievadą, atskiriant juos dvitaškiu. Galima nurodyti pasirinktinį įrašo parametrą `options`, kad būtų galima valdyti toliau pateiktas parinktis:
