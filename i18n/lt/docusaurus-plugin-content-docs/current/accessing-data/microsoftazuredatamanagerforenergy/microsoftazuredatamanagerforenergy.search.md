...
„Microsoft Azure“ duomenų tvarkytuvo, skirto energijai, egzemplioriaus įrašų užklausos


## Examples

### Example #1
Pateikiamas įrašas, kuriame yra užklausą atitinkančių įrašų skaičius ir įrašų, kuriuos pasirinktinai apribojo limito parametras, lentelė
```powerquery
...
Result: 
```powerquery
Naršymo lentelė, kurioje yra [Count = 4947, Records = #table({""Records""}, {{[...]}, {[...]}})]
```
