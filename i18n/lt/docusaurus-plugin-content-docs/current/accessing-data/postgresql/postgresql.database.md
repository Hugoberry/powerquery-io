...
Pateikiama SQL lentelių ir rodinių, pasiekiamų serveryje `server` esančios „PostgreSQL“ duomenų bazės egzemplioriuje, kurio pavadinimas `database`, lentelė. Pasirinktinai kartu su serveriu galima nurodyti prievadą, atskiriant juos dvitaškiu. Galima nurodyti pasirinktinį įrašo parametrą `options`, kad būtų galima valdyti toliau pateiktas parinktis:
