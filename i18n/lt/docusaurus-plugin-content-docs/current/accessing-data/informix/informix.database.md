...
Pateikia SQL lentelių lenteles ir rodinius, prieinamus „Informix“ duomenų bazėje.
...
Pateikiama SQL lentelių ir rodinių, pasiekiamų serveryje `server` esančios „Informix“ duomenų bazės egzemplioriuje, kurio pavadinimas `database`, lentelė . Pasirinktinai kartu su serveriu galima nurodyti prievadą, atskiriant juos dvitaškiu. Galima nurodyti pasirinktinį įrašo parametrą `options`, kad būtų galima valdyti toliau pateiktas parinktis:
...
Pavyzdžiui, įrašo parametras nurodomas kaip \[value1 = option2, value2 = value2...\] arba \[Query = "select ..."\].
