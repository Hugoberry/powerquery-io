...
Pateikiama funkcija, kuri išskaido tekstą į teksto sąrašą pagal perėjimą iš vieno simbolių tipo į kitą. `before` Ir `after` parametrai gali būti simbolių sąrašas arba funkcija, kuri ima simbolį ir pateikia reikšmę „true“ / „false“.
