...
### Example #1 
Gaukite &lt;code&gt;&#34;4&#34;&lt;/code&gt; 64 bitų sveikąją &lt;code&gt;number&lt;/code&gt; vertę.
```powerquery
Int64.From("4")
```
...
### Example #2 
Gaukite 64 bitų sveikąją &lt;code&gt;number&lt;/code&gt; reikšmę iš &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; naudodami &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
