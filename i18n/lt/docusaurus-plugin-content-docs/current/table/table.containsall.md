...
Nurodoma, ar visi nurodyti įrašai įrašų sąraše `rows` rodomi kaip eilutės `table`. Galima nurodyti pasirenkamą parametrą `equationCriteria`, norint valdyti lentelės eilučių palyginimą.
