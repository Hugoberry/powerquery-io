...
Pridedamas stulpelis pavadinimu `newColumnName` prie lentelės `table`. Stulpelio reikšmės apskaičiuojamos naudojant nurodytą pasirinkimo funkciją `columnGenerator`, kur kiekvienoje eilutėje nurodyta įvestis.
