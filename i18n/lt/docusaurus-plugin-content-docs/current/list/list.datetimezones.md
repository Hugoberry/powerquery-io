...
Pateikiamas sąrašas `datetimezone` reikšmių, kurių dydis `count`, pradedant nuo `start`. Nurodytas padidėjimas, `step`, yra `duration` reikšmė, pridedama prie kiekvienos reikšmės.
