...
Pateikia reikšmes iš nurodyto sąrašo, kurios atitinka pasirinkimo sąlygą.

-   `list`: tikrinimui skirtas sąrašas.
-   `selection`: funkcija, kuri nustato pasirenkamas reikšmes.
...
### Example #2
Pasirinkti datas iš sąrašo, kurios patenka į šeštadienį arba sekmadienį.
```powerquery
let
    dates = {
...
### Example #3
Parodyti lentelę aktyvių klientų, kurių pirkimo suma viršija 100 USD.
```powerquery
let
    customers = {
