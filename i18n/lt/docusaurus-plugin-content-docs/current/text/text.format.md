...
Pateikiamas suformatuotas tekstas, sukuriamas taikant `arguments` iš sąrašo arba įrašo į formato eilutę `formatString`. Taip pat gali būti pateiktas pasirinktinis `culture` (pavyzdžiui, „en-US“).
