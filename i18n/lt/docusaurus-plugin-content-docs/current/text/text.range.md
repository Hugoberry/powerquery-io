...
Pateikiama rasta dalinė eilutė iš teksto `text`, kai poslinkis `offset`. Norint nurodyti, kiek simbolių pateikti, galima įtraukti pasirenkamą parametrą `count`. Jei nepakanka simbolių, pateikiama klaida.
