...
Pateikiamas `number` apvalinimo į mažesniąją pusę iki ankstesnio didžiausio sveikojo skaičiaus rezultatas. Jei `number` yra null, ši funkcija pateikia null. Jei nurodyta `digits`, `number` suapvalinama iki nurodyto dešimtainių skaitmenų skaičiaus.
