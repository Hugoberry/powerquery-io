...
Pateikiamas `number` apvalinimo rezultatas, atsižvelgiant į skaičiaus ženklą. Ši funkcija suapvalins teigiamus skaičius į didesniąją pusę ir neigiamus skaičius į mažesniąją pusę. Jei nurodyta `digits`, `number` suapvalinama iki `digits` dešimtainių skaitmenų skaičiaus.
