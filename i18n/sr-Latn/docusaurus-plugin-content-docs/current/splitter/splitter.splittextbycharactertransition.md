...
Vraća funkciju koja deli tekst na listu teksta u skladu sa prelazom sa jedne vrste znaka na drugu. Parametri `before` i `after` mogu da budu lista znakova ili funkcija koja uzima znak i vraća vrednost true/false.
