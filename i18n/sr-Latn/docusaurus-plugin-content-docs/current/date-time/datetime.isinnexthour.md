...
Pokazuje da li se data vrednost datuma i vremena `dateTime` pojavljuje tokom sledećeg časa, na osnovu trenutnog datuma i vremena sistema. Imajte u vidu da će ova funkcija vratiti false kada se prosledi vrednost koja se pojavljuje u okviru trenutnog časa.
