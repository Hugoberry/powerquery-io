...
Dodaje kolonu `newColumnName` u tabelu `table`. Vrednosti za kolonu se izračunavaju pomoću navedene funkcije izbora `columnGenerator`, pri čemu se svaki red smatra unosom.
