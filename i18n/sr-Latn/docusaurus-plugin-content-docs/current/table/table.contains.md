...
Pokazuje da li se navedeni zapis, `row`, pojavljuje kao red u `table`. Može se navesti opcionalni parametar `equationCriteria` radi kontrole poređenja redova iz tabele.
