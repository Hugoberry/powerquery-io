...
Kreira tabelu tipa `columns` od liste `lists` koja sadrži ugnežđene liste sa imenima i vrednostima kolona. Ako neke kolone imaju veći broj vrednosti od drugih, vrednosti koje nedostaju će biti popunjene podrazumevanom vrednošću, „bez vrednosti“, ako kolone mogu biti bez vrednosti.
