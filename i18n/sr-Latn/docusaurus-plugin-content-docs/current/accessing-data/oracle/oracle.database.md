...
Vraća tabelu SQL tabela i prikaza iz Oracle Database na serveru `server`. Uz server se opcionalno može navesti port, razdvojen pomoću dve tačke. Može se navesti opciona vrednost parametra zapisa, `options`, za kontrolu sledećih opcija:
