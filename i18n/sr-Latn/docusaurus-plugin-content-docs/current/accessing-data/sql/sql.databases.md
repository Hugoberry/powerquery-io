...
Vraća tabelu baza podataka na navedenom SQL serveru, `server`. Može se navesti opciona vrednost parametra zapisa, `options`, za kontrolu sledećih opcija:
...
Ne podržava podešavanje SQL upita za pokretanje na serveru. `Sql.Database` umesto toga bi trebalo koristiti za pokretanje SQL upita.
