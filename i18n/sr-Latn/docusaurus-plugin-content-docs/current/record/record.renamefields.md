...
Vraća zapis nakon preimenovanja polja iz unosa `record` u nova imena polja navedena na listi `renames`. Za više preimenovanja se može koristiti ugnežđena lista (\{ \{old1, new1\}, \{old2, new2\} \}).
