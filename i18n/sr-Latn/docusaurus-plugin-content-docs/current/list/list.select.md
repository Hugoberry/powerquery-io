...
Vraća vrednosti sa navedene liste koje zadovoljavaju uslov izbora.

-   `list`: Lista za ispitivanje.
-   `selection`: Funkcija koja određuje vrednosti koje treba izabrati.
...
### Example #2
Izaberite datume sa liste koji padaju u subotu ili nedelju.
```powerquery
let
    dates = {
...
### Example #3
Prikažite tabelu aktivnih kupaca sa ukupnim iznosima kupovine većim od 100 USD.
```powerquery
let
    customers = {
