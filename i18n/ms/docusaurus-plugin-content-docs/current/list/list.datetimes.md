...
Mengembalikan senarai nilai `datetime` dengan saiz `count`, bermula pada `start`. Tokokan yang ditentukan, `step`, ialah nilai `duration` yang ditambah pada setiap nilai.
