...
Mengembalikan hasil pembundaran `number` berdasarkan tanda nombor. Fungsi ini akan membundarkan nombor positif ke atas dan nombor negatif ke bawah. Jika `digits` ditentukan, `number` dibundarkan kepada `digits` bilangan digit perpuluhan.
