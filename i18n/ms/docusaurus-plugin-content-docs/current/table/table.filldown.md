...
Mengembalikan jadual daripada `table` yang ditentukan yang mana nilai sel sebelumnya disebarkan kepada sel bernilai nol di bawah dalam `columns` yang ditentukan.
