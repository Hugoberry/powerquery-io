...
Mengembalikan jadual dengan senarai baris, `rows`, dimasukkan ke dalam `table` pada kedudukan yang ditentukan, `offset`. Setiap lajur dalam baris untuk dimasukkan mesti sepadan dengan jenis lajur pada jadual.
