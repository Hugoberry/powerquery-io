...
Mengembalikan senarai yang mengandungi dua jadual: jadual dengan baris N pertama bagi `table` (seperti yang ditentukan oleh `count`) dan jadual yang mengandungi baris yang tinggal bagi `table`. Jika jadual bagi senarai yang terhasil dinomborkan tepatnya sekali dan dalam tertib, fungsi akan dinomborkan `table` hanya sekali.
