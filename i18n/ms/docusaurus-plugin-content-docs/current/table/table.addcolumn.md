...
Menambah lajur bernama `newColumnName` pada jadual `table`. Nilai untuk lajur dikira menggunakan fungsi pilihan yang ditentukan `columnGenerator` dengan setiap baris diambil sebagai input.
