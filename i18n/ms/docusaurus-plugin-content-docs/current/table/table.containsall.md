...
Menunjukkan sama ada semua rekod yang ditentukan dalam senarai rekod `rows`, muncul sebagai baris dalam `table`. Parameter pilihan `equationCriteria`, mungkin ditentukan untuk mengawal perbandingan antara baris pada jadual.
