...
Mengembalikan fungsi yang memisahkan teks kepada senarai teks menurut transisi daripada satu jenis aksara kepada yang lain. Parameter `before` dan `after` boleh sama ada senarai aksara atau fungsi yang mengambil aksara dan mengembalikan benar/palsu.
