...
Membuat panggilan ke API Stripe di https://api.stripe.com/v1/`method`, dengan rekod `additionalParameters` yang dihantar sebagai parameter tambahan dan senarai `ColumnNames` nama jalur yang dijangka. Versi Stripe 2015-10-16 digunakan.
