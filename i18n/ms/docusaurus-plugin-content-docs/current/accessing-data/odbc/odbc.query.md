...
Mengembalikan hasil daripada menjalankan `query` dengan rentetan sambungan `connectionString` menggunakan ODBC. `connectionString` boleh dalam bentuk teks atau rekod pasangan nilai sifat. Nilai sifat boleh dalam bentuk teks atau nombor. Parameter rekod pilihan, `options`, boleh disediakan untuk menentukan sifat tambahan. Rekod boleh mengandungi medan yang berikut:
