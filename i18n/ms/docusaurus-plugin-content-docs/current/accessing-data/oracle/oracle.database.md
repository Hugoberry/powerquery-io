...
Mengembalikan jadual bagi jadual dan paparan SQL daripada Oracle Database.
...
Mengembalikan jadual bagi jadual dan paparan SQL yang tersedia dalam Oracle Database pada pelayan `server`. Port boleh ditentukan secara pilihan dengan pelayan, diasingkan oleh titik bertindih. Parameter rekod pilihan, `options`, boleh ditentukan untuk mengawal opsyen berikut:
