...
Mengembalikan pangkalan data pada tika Analysis Services, `server`. Parameter rekod pilihan, `options`, boleh diberikan untuk menentukan sifat tambahan. Rekod boleh mengandungi medan berikut:
