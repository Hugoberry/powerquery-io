...
Mengembalikan `count` aksara pertama bagi `text` sebagai nilai teks.
...
### Example #2
Gunakan empat aksara pertama bagi nama pertama dan tiga aksara pertama nama akhir untuk mencipta alamat e-mel individu.
```powerquery
let
