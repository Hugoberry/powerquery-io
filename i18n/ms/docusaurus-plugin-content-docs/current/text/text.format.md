...
Mengembalikan teks diformatkan yang dicipta dengan menggunakan `arguments` daripada senarai atau rekod untuk rentetan format `formatString`. `culture` pilihan juga mungkin diberikan (contohnya, "en-US").
