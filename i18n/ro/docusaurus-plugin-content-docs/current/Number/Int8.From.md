...
### Example #1 
Obțineți valoarea &lt;code&gt;number&lt;/code&gt; întreagă, pe 8 biți și cu semn pentru &lt;code&gt;&#34;4&#34;&lt;/code&gt;.
```powerquery
Int8.From("4")
```
...
### Example #2 
Obțineți valoarea &lt;code&gt;number&lt;/code&gt; întreagă pe 8 biți și cu semn pentru &lt;code&gt;&#34;4.5&#34;&lt;/code&gt;, utilizând &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
