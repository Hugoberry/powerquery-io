...
### Example #1 
Obține valoarea &lt;code&gt;number&lt;/code&gt; întreagă pe 64 de biți a &lt;code&gt;&#34;4&#34;&lt;/code&gt;.
```powerquery
Int64.From("4")
```
...
### Example #2 
Obțineți valoarea &lt;code&gt;number&lt;/code&gt; întreagă pe 64 de biți a &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; utilizând &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
