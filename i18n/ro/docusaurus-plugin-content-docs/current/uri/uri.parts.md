...
Returnează părţile `absoluteUri` de intrare ca înregistrare, conţinând valori, cum ar fi schemă, gazdă, port, cale, interogare, fragment, nume de utilizator şi parolă.
