...
Dacă există doar un element în lista `list`, returnează acel element. Dacă lista este goală, funcția returnează nul dacă nu se specifică `default` opțional. Dacă există mai multe elemente în listă, funcția returnează o eroare.
