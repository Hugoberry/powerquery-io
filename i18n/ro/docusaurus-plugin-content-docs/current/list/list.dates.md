...
Returnează o listă de valori `date` de dimensiunea `count`, începând de la `start`. Incrementul dat, `step`, este o valoare `duration` care este adăugată la fiecare valoare.
