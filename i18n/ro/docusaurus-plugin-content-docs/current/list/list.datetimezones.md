...
Returnează o listă de valori `datetimezone` de dimensiunea `count`, începând de la `start`. Incrementul dat, `step`, este o valoare `duration` care este adăugată la fiecare valoare.
