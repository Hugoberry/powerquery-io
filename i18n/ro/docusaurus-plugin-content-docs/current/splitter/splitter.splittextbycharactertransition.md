...
Returnează o funcție care scindează textul într-o listă de texte conform unei tranziții de la un tip de caractere la altul. Parametrii `before` și `after` pot fi o listă de caractere sau o funcție care ia un caracter și returnează true/false.
