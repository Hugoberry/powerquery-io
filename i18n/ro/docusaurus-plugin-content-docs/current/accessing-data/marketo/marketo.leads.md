...
Creează un apel către punctul final API Marketo REST de la `url`/rest/v1/leads.json. Sunt returnați toți clienții potențiali din lista `IDuriCliențiPotențiali`.
