...
Creează un apel către API-ul Stripe de la https://api.stripe.com/v1/`metodă`, cu înregistrarea `parametriSuplimentari` transmisă ca parametri suplimentari și lista `NumeColoane` a numelor de coloane așteptate. Se utilizează versiunea Stripe 2015-10-16.
