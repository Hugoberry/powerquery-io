...
Elimină `count` de rânduri de la începutul `table`, începând de la `offset` specificată. Un număr implicit 1 este utilizat dacă parametrul `count` nu este furnizat.
