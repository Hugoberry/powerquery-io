...
Devolve uma função que divide o texto numa lista de texto de acordo com uma transição de um tipo de caráter para outro. Os parâmetros `before` e `after` podem ser tanto uma lista de carateres como uma função que utiliza um caráter e devolve verdeiro/falso.
