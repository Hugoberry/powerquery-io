...
Devolve uma tabela de tabelas e vistas SQL a partir da base de dados Teradata.
...
Devolve uma tabela de tabelas e vistas SQL da base de dados Teradata no servidor `server`. A porta pode ser especificada opcionalmente com o servidor, separada por dois-pontos. Pode ser especificado um parâmetro de registo opcional, `options`, para controlar as seguintes opções:
