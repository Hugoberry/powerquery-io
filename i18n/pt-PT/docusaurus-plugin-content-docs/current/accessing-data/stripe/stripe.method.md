...
Efetua uma chamada à API do Stripe em https://api.stripe.com/v1/`method`, com `additionalParameters` de registo transmitido como parâmetros adicionais e lista `ColumnNames` de nomes de colunas esperados. É utilizada a versão do Stripe de 2015-10-16.
