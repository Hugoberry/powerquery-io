...
Devolve o conteúdo do ficheiro no URL, `url`, a partir de um sistema de ficheiros do Azure Data Lake Storage. `options` pode ser especificado para controlar as seguintes opções:
