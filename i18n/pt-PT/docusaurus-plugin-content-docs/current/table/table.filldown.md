...
Devolve uma tabela a partir de `table` especificado em que o valor de uma célula anterior é propagado para as células com valor nulo abaixo do `columns` especificado.
