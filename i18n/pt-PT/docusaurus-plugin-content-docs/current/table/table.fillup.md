...
Devolve uma tabela a partir de `table` especificado em que o valor da próxima célula é propagado para as células com valor nulo acima do `columns` especificado.
