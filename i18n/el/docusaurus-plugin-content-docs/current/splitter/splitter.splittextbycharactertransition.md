...
Επιστρέφει μια συνάρτηση που διαιρεί κείμενο σε μια λίστα κειμένου σύμφωνα με μια μετάβαση από ένα είδος χαρακτήρα σε άλλο. Οι παράμετροι `before` και `after` μπορεί να είναι είτε μια λίστα χαρακτήρων είτε μια συνάρτηση η οποία λαμβάνει έναν χαρακτήρα και επιστρέφει true/false.
