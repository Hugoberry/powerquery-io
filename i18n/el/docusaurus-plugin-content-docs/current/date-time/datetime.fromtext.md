...
### Example #1
Μετατροπή `"2010-12-31T01:30:00"` σε τιμή ημερομηνίας/ώρας.
```powerquery
...
### Example #2
Μετατροπή `"2010-12-31T01:30:00.121212"` σε τιμή ημερομηνίας/ώρας.
```powerquery
...
### Example #4
Μετατροπή `"20101231T013000"` σε τιμή ημερομηνίας/ώρας.
```powerquery
