...
Κάνει μια κλήση στο API Stripe στο https://api.stripe.com/v1/`method`, με την προαιρετική εγγραφή `query` να διαβιβάζεται ως πρόσθετοι παράμετροι και το προαιρετικό `pageLimit` ως όριο στον αριθμό αιτήσεων API. Τα πιο πρόσφατα δεδομένα επιστρέφονται πρώτα. Αν δεν καθοριστεί `pageLimit`, επιστρέφονται όλα τα δεδομένα. Χρησιμοποιείται η έκδοση Stripe 2015-10-16.
