...
Κάνει μια κλήση στο API Stripe στο https://api.stripe.com/v1/`method`, με την εγγραφή `additionalParameters` να διαβιβάζεται ως πρόσθετοι παράμετροι και τη λίστα `ColumnNames` των αναμενόμενων ονομάτων στηλών. Χρησιμοποιείται η έκδοση Stripe 2015-10-16.
