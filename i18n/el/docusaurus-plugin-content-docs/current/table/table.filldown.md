...
Επιστρέφει έναν πίνακα από την καθορισμένη `table` όπου η τιμή του προηγούμενου κελιού μεταδίδεται παρακάτω στα κελιά με τιμές που είναι null στην καθορισμένη `columns`.
