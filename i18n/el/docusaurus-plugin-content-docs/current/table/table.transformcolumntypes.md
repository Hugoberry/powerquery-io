...
### Example #1
Μετασχηματίστε τις αριθμητικές τιμές στην πρώτη στήλη σε τιμές κειμένου.
```powerquery
let
...
### Example #2
Μετασχηματίζει τις ημερομηνίες του πίνακα με ισοδύναμα γαλλικά κείμενα.
```powerquery
let
...
### Example #3
Μετασχηματίζει τις ημερομηνίες του πίνακα στα αντίστοιχα γερμανικά κείμενα και τις τιμές του πίνακα σε ποσοστά.
```powerquery
let
