...
Καταργεί τις `count` γραμμές που ξεκινούν από `table`, ξεκινώντας από το `offset` που καθορίστηκε. Σε περίπτωση που δεν παρέχεται η παράμετρος `count`, χρησιμοποιείται το προεπιλεγμένο πλήθος 1.
