...
### Example #4
Μετακινήστε τις προγραμματισμένες εργασίες συντήρησης που πραγματοποιούνται ημέρες αργίας στις ΗΠΑ την επόμενη ημέρα ή, εάν η αργία πραγματοποιείται την Παρασκευή, την επόμενη Δευτέρα.
```powerquery
let
