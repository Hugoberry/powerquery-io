...
Υποδεικνύει αν η καθορισμένη εγγραφή, `row`, εμφανίζεται ως γραμμή στον `table`. Μπορεί να καθοριστεί μια προαιρετική παράμετρος `equationCriteria` για τον έλεγχο της σύγκρισης μεταξύ των γραμμών του πίνακα.
