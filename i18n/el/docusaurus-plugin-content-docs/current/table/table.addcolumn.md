...
Προσθέτει μια στήλη με το όνομα `newColumnName` στον πίνακα `table`. Οι τιμές για τη στήλη υπολογίζονται με τη χρήση της καθορισμένης συνάρτησης επιλογής `columnGenerator` με κάθε γραμμή να λαμβάνεται ως είσοδος.
