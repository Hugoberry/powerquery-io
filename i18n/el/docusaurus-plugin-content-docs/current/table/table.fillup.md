...
Επιστρέφει έναν πίνακα από την καθορισμένη `table` όπου η τιμή του επόμενου κελιού μεταδίδεται παραπάνω στα κελιά με τιμές που είναι null στην καθορισμένη `columns`.
