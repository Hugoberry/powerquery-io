...
### Example #2
Μετατροπή του καθορισμένου αριθμού σε τιμή ημερομηνίας.
```powerquery
Date.From(43910)
```
...
### Example #3
Μετατρέψτε τις γερμανικές ημερομηνίες κειμένου στη στήλη "Ημερομηνία δημοσίευσης" σε τιμές ημερομηνίας.
```powerquery
let
