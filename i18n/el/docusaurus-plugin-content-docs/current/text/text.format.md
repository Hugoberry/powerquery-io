...
Επιστρέφει μορφοποιημένο κείμενο που δημιουργείται εφαρμόζοντας το `arguments` από μια λίστα ή εγγραφή σε μια συμβολοσειρά μορφοποίησης `formatString`. Ενδέχεται επίσης να παρέχεται μια προαιρετική τιμή `culture` (για παράδειγμα, "en-US").
