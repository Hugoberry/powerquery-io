...
### Example #1 
Λάβετε την τιμή ακέραιου 16 bit &lt;code&gt;number&lt;/code&gt; του &lt;code&gt;&#34;4&#34;&lt;/code&gt;.
```powerquery
Int64.From("4")
```
...
### Example #2 
Λάβετε την τιμή ακέραιου 16 bit &lt;code&gt;number&lt;/code&gt; του &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; χρησιμοποιώντας το &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
