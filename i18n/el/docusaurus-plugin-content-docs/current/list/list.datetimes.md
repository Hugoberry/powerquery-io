...
Επιστρέφει μια λίστα τιμών `datetime` μεγέθους `count`, που αρχίζουν από το `start`. Η προσαύξηση που δίνεται, `step`, είναι μια τιμή `duration` που προστίθεται σε κάθε τιμή.
