...
Επιστρέφει τις μέγιστες τιμές στη λίστα. Πρέπει να καθοριστεί ο αριθμός των τιμών που θα επιστραφούν ή μια συνθήκη φίλτρου.
...
### Example #3
Βρείτε τις τρεις πιο πρόσφατες ημερομηνίες από μια λίστα με γερμανικές ημερομηνίες.
```powerquery
let
