...
`list` listesinde yalnızca bir öğe varsa bu öğeyi döndürür. Liste boşsa isteğe bağlı bir `default` belirtilmediyse işlev null döndürür. Listede birden çok öğe varsa işlev bir hata döndürür.
