...
`record` kaydının `fields` içinde belirtilen alanları içerip içermediğini bir mantıksal değer döndürerek (doğru veya yanlış) gösterir. Birden çok alan değeri liste kullanılarak belirtilebilir.
