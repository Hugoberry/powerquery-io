...
Menambahkan kolom bernama `newColumnName` ke tabel `table`. Nilai untuk kolom tersebut dikomputasi menggunakan fungsi pilihan `columnGenerator` yang ditetapkan dengan setiap baris yang diambil sebagai input.
