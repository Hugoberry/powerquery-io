...
Menghasilkan tabel berisi tabel dan tampilan SQL dari Oracle database.
...
Menghasilkan tabel berisi tabel dan tampilan SQL dari Oracle database di server `server`. Port mungkin ditentukan secara opsional dengan server, dipisahkan oleh titik dua. Parameter catatan opsional, `options`, dapat ditentukan untuk mengontrol opsi berikut:
