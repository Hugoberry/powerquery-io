...
Menghasilkan tabel berisi tabel dan tampilan SQL dari database Teradata.
...
Menghasilkan tabel berisi tabel dan tampilan SQL dari database Teradata pada server `server`. Port mungkin ditentukan secara opsional dengan server, dipisahkan oleh titik dua. Parameter catatan opsional, `options`, dapat ditentukan untuk mengontrol opsi berikut:
