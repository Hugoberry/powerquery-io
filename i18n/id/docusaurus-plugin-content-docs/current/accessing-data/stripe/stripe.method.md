...
Melakukan panggilan ke Stripe API di https://api.stripe.com/v1/`method`, dengan rekaman `additionalParameters` yang diberikan sebagai parameter tambahan dan daftar `ColumnNames` nama kolom yang diminta. Stripe Versi 2015-10-16 sedang digunakan.
