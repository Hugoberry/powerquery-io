...
Menghasilkan sebuah tabel dari tabel SQL dan tampilan dari sumber data ODBC yang ditetapkan oleh string koneksi `connectionString`. `connectionString` dapat berupa teks atau catatan pasangan nilai properti. Nilai properti dapat berupa teks atau angka. Sebuah parameter catatan opsional, `options`, mungkin diberikan untuk menentukan properti tambahan. Catatan dapat berisi bidang berikut:
