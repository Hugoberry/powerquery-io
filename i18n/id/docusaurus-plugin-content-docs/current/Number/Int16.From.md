...
### Example #2 
Dapatkan nilai &lt;code&gt;number&lt;/code&gt; bilangan bulat 16 bit &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; menggunakan &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
