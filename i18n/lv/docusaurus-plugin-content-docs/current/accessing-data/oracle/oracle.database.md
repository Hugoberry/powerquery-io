...
Tiek atgriezta SQL tabulu un skatu tabula no Oracle datu bāzes.
...
Atgriež tabulu ar SQL tabulām un skatiem no Oracle datu bāzes serverī `server`. Kopā ar serveri pēc izvēles var norādīt portu, atdalot to ar kolu. Var norādīt neobligātu ieraksta parametru `options`, lai pārvaldītu tālāk minētās opcijas.
