...
Šī funkcija izsauc pakalpojuma Stripe API adresē https://api.stripe.com/v1/`metode`, pieņemot ierakstu `additionalParameters` kā papildu parametrus un paredzēto kolonnu nosaukumu sarakstu `ColumnNames`. Tiek izmantota pakalpojuma Stripe versija 2015-10-16.
