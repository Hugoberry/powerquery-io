...
Tiek atgrieztas vērtības no norādītā saraksta, kas atbilst atlases nosacījumam.

-   `list`: saraksts, kas jāizpēta.
-   `selection`: funkcija, kas nosaka atlasāmās vērtības.
...
### Example #2
Atlasiet datumus sarakstā, kas ir sestdienā vai svētdienā.
```powerquery
let
    dates = {
...
### Example #3
Parādīt aktīvo klientu tabulu ar pirkumu kopsummām, kas pārsniedz 100 ASV dolāru.
```powerquery
let
    customers = {
