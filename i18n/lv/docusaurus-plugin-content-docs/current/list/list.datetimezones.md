...
Tiek atgriezts tipa `datetimezone` vērtību saraksts, kura vērtību skaits ir `count` un pirmā vērtība ir `start`. Norādītais palielinājums `step` ir tipa `duration` vērtība, kas tiek pieskaitīta katrai saraksta vērtībai.
