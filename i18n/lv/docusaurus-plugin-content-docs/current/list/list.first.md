...
Tiek atgriezts saraksta `list` pirmais vienums vai papildu noklusējuma vērtība `defaultValue`, ja saraksts ir tukšs. Ja saraksts ir tukšs un nav norādīta noklusējuma vērtība, funkcija atgriež vērtību `Null`.
