...
ถ้ามีเพียงข้อมูลเดียวในรายการ `list` ให้ส่งกลับข้อมูลนั้น ถ้ารายการว่างเปล่า ฟังก์ชันจะส่งกลับ null เว้นแต่จะมีการระบุ `default` เพิ่มเติม ถ้าในรายการมีมากกว่าหนึ่งข้อมูล ฟังก์ชันจะส่งกลับข้อผิดพลาด
