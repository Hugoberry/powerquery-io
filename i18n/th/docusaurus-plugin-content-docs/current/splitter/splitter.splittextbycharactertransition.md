...
ส่งกลับฟังก์ชันที่แยกข้อความออกเป็นรายการข้อความตามการเปลี่ยนจากอักขระชนิดหนึ่งไปยังอีกชนิดหนึ่ง พารามิเตอร์ `before` และ `after` อาจเป็นรายการอักขระ หรือฟังก์ชันที่ใช้อักขระ และส่งกลับค่า จริง/เท็จ ได้
