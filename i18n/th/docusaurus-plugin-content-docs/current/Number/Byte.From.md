...
### Example #1 
รับค่า &lt;code&gt;ตัวเลข&lt;/code&gt; ที่เป็นจำนวนเต็ม 8 บิตสำหรับ &lt;code&gt;&#34;4&#34;&lt;/code&gt;
```powerquery
Byte.From("4")
```
...
### Example #2 
รับค่า &lt;code&gt;ตัวเลข&lt;/code&gt; ที่เป็นจำนวนเต็ม 8 บิตสำหรับ &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; โดยใช้ &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;
```powerquery
