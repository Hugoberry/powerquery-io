...
ส่งคืนข้อความที่จัดรูปแบบซึ่งสร้างโดยการนำ `arguments` ไปใช้จากรายการหรือระเบียนไปยังสตริงรูปแบบ `formatString` อาจมีการระบุ `culture` เพิ่มเติม (ตัวอย่างเช่น "en-US")
