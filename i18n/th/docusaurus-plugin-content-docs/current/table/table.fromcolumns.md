...
สร้างตารางชนิด `columns` จากรายการ `lists` ซึ่งมีรายการที่ซ้อนกันที่มีชื่อและค่าของคอลัมน์ ถ้าบางคอลัมน์มีค่ามากกว่าคอลัมน์อื่น ค่าที่หายไปจะถูกเติมด้วยค่าเริ่มต้น 'null' ถ้าคอลัมน์ดังกล่าวสามารถเป็น null ได้
