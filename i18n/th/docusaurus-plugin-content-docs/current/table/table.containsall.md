...
แสดงว่าจะให้ทุกระเบียนที่ระบุในรายการระเบียน `rows` ปรากฏเป็นแถวใน `table` หรือไม่ พารามิเตอร์ที่เลือกได้ `equationCriteria` อาจถูกระบุเพื่อควบคุมการเปรียบเทียบระหว่างแถวของตาราง
