...
ส่งกลับส่วนหัวที่ดาวน์โหลดจาก `url` เป็นระเบียน พารามิเตอร์ระเบียนเพิ่มเติม `options` อาจมีให้เพื่อระบุคุณสมบัติเพิ่มเติม ระเบียนสามารถมีเขตข้อมูลต่อไปนี้:
...
### Example #1
เรียกใช้ส่วนหัว HTTP สําหรับ `"https://bing.com/search?q=Power+Query"` ที่ใช้ตัวเลือก RelativePath และ Query
```powerquery
let
