...
ส่งกลับตารางการนำทางที่มีแถวของแต่ละคอนเทนเนอร์ที่พบใน URL บัญชี `account` จากชุดเก็บข้อมูลประจำตัวที่จัดเก็บ Azure แต่ละแถวประกอบด้วยการเชื่อมโยงไปยัง blob ของคอนเทนเนอร์ อาจมีการระบุ `options` เพื่อควบคุมตัวเลือกต่อไปนี้:
