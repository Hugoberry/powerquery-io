...
เปลี่ยนแปลงข้อมูลโซนเวลาของค่าโซนวันที่เวลา `dateTimeZone` เป็นข้อมูลโซนเวลาท้องถิ่น ถ้า `dateTimeZone` ไม่มีคอมโพเนนต์โซนเวลา ข้อมูลโซนเวลาท้องถิ่นจะถูกเพิ่ม
