...
Vrátí části identifikátoru `absoluteUri` vstupu jako záznam, který obsahuje hodnoty jako například Scheme, Host, Port, Path, Query, Fragment, UserName a Password.
