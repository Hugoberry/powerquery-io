...
Značí, zda se mají všechny zadané záznamy v seznamu záznamů `rows` zobrazovat jako řádky tabulky `table`. Za účelem řízení porovnání mezi řádky tabulky může být určen volitelný parametr `equationCriteria`.
