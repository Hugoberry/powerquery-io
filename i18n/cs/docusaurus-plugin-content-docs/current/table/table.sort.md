...
Seřadí tabulku `table` pomocí seznamu jednoho nebo více názvů sloupců a volitelného parametru `comparisonCriteria` ve formátu \{ \{ col1, comparisonCriteria \}, \{col2\} \}.
