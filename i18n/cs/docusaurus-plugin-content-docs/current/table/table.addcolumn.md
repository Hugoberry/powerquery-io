...
Přidá sloupec `newColumnName` do tabulky `table`. Hodnoty sloupce jsou vypočítány pomocí zadané výběrové funkce `columnGenerator` a jednotlivých řádků, které jsou použity jako vstup.
