...
Značí, zda se má zadaný záznam (`row`) zobrazovat jako řádek tabulky `table`. Za účelem řízení porovnání mezi řádky tabulky může být určen volitelný parametr `equationCriteria`.
