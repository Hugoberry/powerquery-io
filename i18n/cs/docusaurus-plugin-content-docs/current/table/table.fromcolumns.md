...
Vytvoří ze seznamu `lists` tabulku typu `columns`, která obsahuje vnořené seznamy s názvy a hodnotami sloupců. Pokud mají některé sloupce více hodnot než jiné, chybějící hodnoty budou zaplněny výchozí hodnotou null, pokud sloupce umožňují použití hodnoty null.
