...
Vrátí první pozici libovolného znaku v seznamu `characters` nalezeného v `text`. Volitelný parametr `occurrence` lze použít k určení pozice výskytu, která se má vrátit.
