...
Vrátí dílčí řetězec z textu `text` nalezený na posunu `offset`. K určení počtu vrácených znaků se může použít volitelný parametr `count`. Vyvolá chybu, když znaků není dost.
