...
Vrátí formátovaný text, který se vytvoří, když se použije `arguments` ze seznamu nebo záznamu na formátovací řetězec `formatString`. Volitelně je možné zadat i `culture` (např. en-US).
