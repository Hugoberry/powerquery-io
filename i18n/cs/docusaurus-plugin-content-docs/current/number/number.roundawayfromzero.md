...
Vrátí výsledek zaokrouhlení hodnoty `number` na základě znaménka čísla. Tato funkce zaokrouhlí kladná čísla nahoru a záporná čísla dolů. Pokud se zadá `digits`, `number` se zaokrouhlí na tento počet desetinných číslic: `digits`.
