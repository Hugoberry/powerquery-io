...
Vrátí funkci, která rozdělí text na seznam textů na základě přechodu z jednoho druhu znaků na jiný. Parametry `before` a `after` mohou být buď seznam znaků, nebo funkce, která přijímá znak a vrací hodnotu true nebo false.
