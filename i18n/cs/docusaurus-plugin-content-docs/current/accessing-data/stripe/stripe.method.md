...
Zavolá rozhraní Stripe API na adrese https://api.stripe.com/v1/`metoda` se záznamem dodatečných parametrů `další_parametry` a seznamem názvů očekávaných sloupců `názvy_sloupců`. Použije se Stripe verze 2015-10-16.
