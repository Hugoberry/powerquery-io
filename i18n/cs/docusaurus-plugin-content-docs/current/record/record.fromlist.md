...
Vrátí záznam na základě seznamu hodnot polí `list` a sady polí. Záznam `fields` lze zadat pomocí seznamu textových hodnot nebo typu záznamu. Pokud pole nejsou jedinečná, vyvolá se chyba.
