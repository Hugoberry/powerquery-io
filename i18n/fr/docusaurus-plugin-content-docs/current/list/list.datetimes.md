...
Retourne une liste de valeurs `datetime` de taille `count`, démarrant par `start`. L'incrément spécifié, `step`, est une valeur `duration` qui est ajoutée à chaque valeur.
