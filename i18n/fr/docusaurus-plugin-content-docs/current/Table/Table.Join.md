...
</ul><br />Vous pouvez inclure un ensemble facultatif de <code>keyEqualityComparers</code> pour spécifier comment comparer les colonnes clés. Ce paramètre est actuellement réservé à une utilisation interne.<br />
