...
Effectue un appel à l'API Stripe de https://api.stripe.com/v1/`method`, avec des `additionalParameters` d'enregistrement passés comme paramètres supplémentaires et les `ColumnNames` de la liste des noms de colonnes attendus. Stripe version 2015-10-16 est utilisé.
