...
Renvoie l'équivalent numérique du `character`.  
  
Le résultat sera le point de code Unicode 21 bits représenté par le caractère fourni ou la paire de substitution.
