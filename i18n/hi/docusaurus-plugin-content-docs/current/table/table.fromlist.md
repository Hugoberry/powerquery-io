...
सूची के प्रत्येक आइटम पर वैकल्पिक विभाजन फ़ंक्शन, `splitter`, लागू करके एक सूची, `list` को एक तालिका में कनवर्ट करता है. डिफ़ॉल्ट रूप से, सूची को ऐसे पाठ मानों की सूची माना जाता है जो अल्पविरामों से विभाजित है. वैकल्पिक `columns`, स्तंभों की संख्या, स्तंभों की सूची या TableType हो सकती है. वैकल्पिक `default` और `extraValues` भी निर्दिष्ट किए जा सकते हैं.
