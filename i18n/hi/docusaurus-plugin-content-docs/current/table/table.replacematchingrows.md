...
`table` में निर्दिष्ट सभी पंक्तियों को प्रदान की गई पंक्तियों से बदलता है. बदली जाने वाली पंक्तियों और प्रतिस्थापन को \{old, new\} स्वरूपण का उपयोग करके `replacements` में निर्दिष्ट किया जाता है. तालिका की पंक्तियों के बीच तुलना को नियंत्रित करने के लिए एक वैकल्पिक `equationCriteria` पैरामीटर निर्दिष्ट किया जा सकता है.
