...
संकेत देता है कि रिकॉर्ड की सूची `rows` में सभी निर्दिष्ट रिकॉर्ड, `table` में पंक्तियों के रूप में दिखाई देते हैं या नहीं. तालिका की पंक्तियों की तुलना को नियंत्रित करने के लिए कोई वैकल्पिक पैरामीटर `equationCriteria` निर्दिष्ट किया जा सकता है.
