...
एक Azure डेटा लेक संग्रहण फ़ाइल सिस्टम से URL की फ़ाइल की सामग्री, `url` पर लौटाता है. निम्नलिखित विकल्पों को नियंत्रित करने के लिए `options` को निर्दिष्ट किया जा सकता है:
