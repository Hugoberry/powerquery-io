...
https://api.stripe.com/v1/`method` पर रिकॉर्ड `additionalParameters` के अतिरिक्त पैरामीटर के रूप में पास होने और अपेक्षित नामों की सूची `ColumnNames` के साथ Stripe API को कॉल करता है. Stripe संस्करण 2015-10-16 का उपयोग किया गया है.
