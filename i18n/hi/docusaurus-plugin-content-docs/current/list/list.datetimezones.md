...
`start` से प्रारंभ होने वाले, आकार `count` के `datetimezone` मानों की सूची लौटाता है. दी गई वृद्धि, `step`, एक `duration` मान है जिसे प्रत्येक मान में जोड़ा जाता है.
