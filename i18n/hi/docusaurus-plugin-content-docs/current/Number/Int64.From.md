...
### Example #1 
&lt;code&gt;&#34;4&#34;&lt;/code&gt; का 64-बिट पूर्णांक &lt;code&gt;number&lt;/code&gt; मान प्राप्त करें.
```powerquery
Int64.From("4")
```
...
### Example #2 
&lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt; का उपयोग करके &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; के 64-बिट पूर्णांक &lt;code&gt;संख्या&lt;/code&gt; मान प्राप्त करें.
```powerquery
