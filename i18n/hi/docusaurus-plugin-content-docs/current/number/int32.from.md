...
दिए गए मान से 32-बिट पूर्णांक बनाता है.
...
### Example #2
`RoundingMode.AwayFromZero` का उपयोग करके `"4.5"` का 32-बिट पूर्णांक `संख्यात्मक` मान प्राप्त करें.
```powerquery
