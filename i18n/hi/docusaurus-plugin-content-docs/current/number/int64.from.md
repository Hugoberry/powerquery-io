...
### Example #2
`RoundingMode.AwayFromZero` का उपयोग करके `"4.5"` के 64-बिट पूर्णांक `संख्या` मान प्राप्त करें.
```powerquery
