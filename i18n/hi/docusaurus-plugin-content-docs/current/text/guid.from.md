...
दिए गए `value` से `Guid.Type` वापस करता है. यदि दिया गया `value` `नल` है, तो `Guid.From` `नल` वापस करता है. यह देखने के लिए जाँच की जाएगी कि दिया गया `value` स्वीकार करने योग्य फ़ॉर्मेट में है या नहीं. स्वीकार करने योग्य फ़ॉर्मेट उदाहरणों में प्रदान किए गए हैं.
