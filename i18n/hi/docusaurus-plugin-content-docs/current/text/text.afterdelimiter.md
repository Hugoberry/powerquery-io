...
निर्दिष्ट `delimiter` के बाद `text` का भाग लौटाता है. वैकल्पिक सांख्यिक `index` इंगित करता है कि `delimiter` की किस आवृत्ति पर विचार करना चाहिए. वैकल्पिक सूची `index` इंगित करती है कि `delimiter` की किस आवृत्ति पर विचार किया जाना चाहिए, साथ ही साथ यह कि इनपुट के प्रारंभ या उसकी समाप्ति से इंडेक्सिंग संपन्न करना चाहिए या नहीं.
