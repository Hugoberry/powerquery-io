...
Cho biết giá trị datetime cho trước `dateTime` có xuất hiện trong giây hiện tại hay không, khi được xác định bằng ngày và giờ hiện tại trên hệ thống.
