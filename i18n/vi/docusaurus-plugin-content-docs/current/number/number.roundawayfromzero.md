...
Trả về kết quả làm tròn `number` dựa trên dấu của số. Hàm này sẽ làm tròn số dương lên và số âm xuống. Nếu `digits` được chỉ định, `number` được làm tròn về `digits` số thập phân.
