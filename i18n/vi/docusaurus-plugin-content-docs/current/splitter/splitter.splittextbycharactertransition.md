...
Trả về một hàm tách văn bản thành danh sách văn bản bằng cách chuyển loại ký tự này thành loại ký tự khác. Các tham số `before` và `after` có thể là danh sách các ký tự hoặc hàm nhận một ký tự và trả về giá trị true/false.
