...
Hiermee wordt een niet-hoofdlettergevoelige vergelijkingsfunctie geretourneerd die rangtelwoordregels gebruikt om de opgegeven waarden `x` en `y` te vergelijken.  
...
### Example #1
Abc met abc vergelijken met ordinale regels waarbij geen onderscheid worden gemaakt tussen hoofdletters en kleine letters. Abc is minder dan abc met `Comparer.Ordinal`.
```powerquery
