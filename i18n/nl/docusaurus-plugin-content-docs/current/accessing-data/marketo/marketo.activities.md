...
Hiermee wordt het eindpunt van de Marketo REST API op `url`/rest/v1/activities.json aangeroepen. Alle activiteiten in de lijst `activityIds` hebben plaatsgevonden sinds `startTime` is geretourneerd.
