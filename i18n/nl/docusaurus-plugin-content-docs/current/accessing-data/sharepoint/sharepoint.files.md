...
Hiermee wordt een tabel geretourneerd die een rij bevat voor elk document dat in de opgegeven SharePoint-lijst, `url`, en in submappen wordt gevonden. Elke rij bevat eigenschappen van de map of het bestand en een koppeling naar de bijbehorende inhoud. U kunt `options` opgeven om de volgende opties te bepalen:
