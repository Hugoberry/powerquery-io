...
Hiermee wordt de Stripe API op https://api.stripe.com/v1/`method` aangeroepen, waarbij de record `additionalParameters` als aanvullende parameters wordt doorgegeven en de lijst `ColumnNames` met de verwachte kolomnamen wordt geretourneerd. Stripe-versie 2015-10-16 wordt gebruikt.
