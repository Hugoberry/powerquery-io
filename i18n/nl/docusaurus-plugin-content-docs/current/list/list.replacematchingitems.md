...
Voert de opgegeven vervangingen door in de lijst `list`. Een vervanging `replacements` bestaat uit een lijst met twee waarden, de oude waarde en de nieuwe waarde, die worden aangeleverd als een lijst. Er kan een optionele waarde voor de vergelijkingsvoorwaarde, `equationCriteria`, voor het controleren van de gelijkheidstest worden opgegeven.
