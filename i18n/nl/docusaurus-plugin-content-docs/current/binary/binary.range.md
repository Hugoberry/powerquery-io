...
Hiermee wordt een subset van de binaire waarde geretourneerd, te beginnen bij de marge `binary`. Met een optionele parameter, `offset`, wordt de maximale lengte van de subset ingesteld.
