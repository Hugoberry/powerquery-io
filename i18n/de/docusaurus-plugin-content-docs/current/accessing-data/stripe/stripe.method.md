...
Ruft die Stripe-API unter https://api.stripe.com/v1/`method` auf, wobei der Datensatz `additionalParameters` als zusätzlicher Parameter und die Liste `ColumnNames` mit erwarteten Spaltennamen übergeben wird. Es wird Stripe-Version 2015-10-16 verwendet.
