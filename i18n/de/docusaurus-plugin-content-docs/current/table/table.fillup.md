...
Gibt eine Tabelle auf der Grundlage des angegebenen Elements vom Typ '`table`' zurück, wobei der Wert der nächsten Zelle an die darüber liegenden Zellen mit NULL-Wert im angegebenen Element vom Typ '`columns`' weitergegeben wird.
