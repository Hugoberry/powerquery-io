...
Palauttaa M-lausekkeen `document` arvioinnin tuloksen niiden käytettävissä olevien tunnisteiden avulla, joihin voidaan viitata kohteen `environment` määrittämänä.
