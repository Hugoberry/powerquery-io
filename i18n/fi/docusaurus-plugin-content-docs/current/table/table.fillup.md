...
Palauttaa määritetystä kohteesta `table` taulukon, jossa seuraavan solun arvo levitetään määritetyssä kohteessa `columns` yläpuolella oleviin tyhjäarvoisiin soluihin.
