...
Luo luettelosta `rows` taulukon, jossa luettelon kukin elementti on sisempi luettelo, joka sisältää yksittäisen rivin sarakearvot. Kohteelle `columns` voidaan antaa valinnainen sarakenimien luettelo, taulukkotyyppi tai sarakkeiden määrä.
