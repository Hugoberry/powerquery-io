...
Lisää uuden sarakkeen `newColumnName` kohteeseen `table` edustavilla arvoilla `columnName`. Edustajat saadaan sumealla kohteen `columnName` kunkin rivin arvojen vastaavuudella.
