...
Lisää sarakkeen `newColumnName` taulukkoon `table`. Sarakkeen arvot lasketaan käyttäen määritettyä valintafunktiota `columnGenerator` ja käyttäen kutakin otettua riviä syötteenä.
