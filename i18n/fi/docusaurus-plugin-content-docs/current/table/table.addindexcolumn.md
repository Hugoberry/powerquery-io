...
Liittää kohteeseen `table` sarakkeen `newColumnName`, jolla on eksplisiittiset sijaintiarvot. Valinnainen arvo `initialValue`, alkuindeksiarvo. Valinnainen arvo `increment`. Määrittää, miten paljon kutakin indeksiarvoa suurennetaan.
