...
Luo luettelosta `lists` tyyppiä `columns` olevan taulukon, joka sisältää sisäkkäisiä luetteloita, joissa on sarakkeiden nimiä ja arvoja. Jos joissakin sarakkeissa on enemmän arvoja kuin muissa, puuttuvat arvot täytetään oletusarvolla null, jos sarakkeet tukevat tyhjäarvoja.
