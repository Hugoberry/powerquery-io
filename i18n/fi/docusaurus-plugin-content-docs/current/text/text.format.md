...
Palauttaa muotoillun tekstin, joka luodaan käyttämällä kohdetta `arguments` tietueluettelosta muotoilumerkkijonoon `formatString`. Valinnainen `culture` voidaan myös antaa (esimerkiksi en-US).
