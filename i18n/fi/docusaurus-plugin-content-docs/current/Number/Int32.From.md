...
### Example #2 
Hanki kohteen &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; 32-bittinen kokonaislukumuotoinen &lt;code&gt;number&lt;/code&gt;-arvo käyttämällä kohdetta &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
