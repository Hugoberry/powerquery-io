...
### Example #1 
Hanki allekirjoitettu 8-bittinen kokonaislukumuotoinen &lt;code&gt;number&lt;/code&gt;-arvo kohteesta &lt;code&gt;&#34;4&#34;&lt;/code&gt;.
```powerquery
Int8.From("4")
```
...
### Example #2 
Hanki kohteen &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; allekirjoitettu 8-bittinen kokonaislukumuotoinen &lt;code&gt;number&lt;/code&gt;-arvo käyttämällä kohdetta &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
