...
Palauttaa SQL-taulukoiden ja -näkymien taulukon Oracle Database -tietokannasta palvelimella `server`. Portti voidaan valinnaisesti määrittää palvelimen kanssa erotettuna kaksoispisteellä. Valinnainen tietueparametri `options` voidaan määrittää seuraavien asetusten hallintaa varten:
