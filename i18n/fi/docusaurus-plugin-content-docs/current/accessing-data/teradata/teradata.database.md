...
Palauttaa Teradata-tietokannan SQL-taulukoiden ja näkymien taulukon.
...
Palauttaa SQL-taulukoiden ja -näkymien taulukon Teradata-tietokannasta palvelimella `server`. Portti voidaan valinnaisesti määrittää palvelimen kanssa erotettuna kaksoispisteellä. Valinnainen tietueparametri `options` voidaan määrittää seuraavien asetusten hallintaa varten:
