...
Tekee kutsun Stripe-ohjelmointirajapinnalle osoitteessa https://api.stripe.com/v1/`method` niin, että välitetään tietue `additionalParameters` lisäparametreina ja luettelo `ColumnNames` odotetuista sarakkeiden nimistä. Stripe-versiota 2015-10-16 käytetään.
