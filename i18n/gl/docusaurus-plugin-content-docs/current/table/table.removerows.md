...
Elimina `count` de filas desde o inicio da `table`, comezando na `offset` especificada. Utilízase unha conta predefinida de 1 se non se fornece o parámetro `count`.
