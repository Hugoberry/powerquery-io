...
Crea unha táboa a partir da lista `rows` onde cada elemento da lista é unha lista interna que contén os valores de columnas para unha fila única. Pódese fornecer unha lista opcional de nomes de columnas, un tipo de táboa ou un número de columnas para `columns`.
