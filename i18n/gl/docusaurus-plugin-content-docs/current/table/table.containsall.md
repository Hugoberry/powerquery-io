...
Indica se todos os rexistros especificados na lista de rexistros `rows` aparecen como filas en `table`. Pódese especificar un parámetro opcional `equationCriteria` para controlar a comparación entre as filas da táboa.
