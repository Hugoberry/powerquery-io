...
Crea unha táboa de tipo `columns` dunha lista `lists` que contén listas aniñadas con valores e nomes de columna. Se algunhas columnas teñen máis valores que outras, os valores que faltan encheranse co valor predefinido, "nulo", se as columnas poden ter valores nulos.
