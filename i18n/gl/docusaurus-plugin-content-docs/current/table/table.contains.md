...
Indica se o rexistro especificado, `row`, aparece como unha fila en `table`. Pódese especificar un parámetro opcional `equationCriteria` para controlar a comparación entre as filas da táboa.
