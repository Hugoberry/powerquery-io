...
Devolve unha lista de valores `datetimezone` de tamaño `count`, comezando en `start`. O incremento indicado, `step`, é un valor `duration` que se engade a cada valor.
