...
Se só hai un elemento na lista `list`, devolve ese elemento. Se a lista está baleira, a función devolve nulo a non ser que se especifique un valor `default` opcional. Se hai máis dun elemento na lista, a función devolve un erro.
