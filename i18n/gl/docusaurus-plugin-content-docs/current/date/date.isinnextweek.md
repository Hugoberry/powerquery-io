...
Indica se o valor dataHora `dateTime` fornecido ocorre durante a próxima semana, tal e como o determinan a data e hora actuais do sistema. Teña en conta que esta función devolverá false se se pasa un valor que ocorre na semana actual.
