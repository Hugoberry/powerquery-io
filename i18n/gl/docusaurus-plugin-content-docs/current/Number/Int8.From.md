...
### Example #2 
Obteña o valor &lt;code&gt;number&lt;/code&gt; enteiro de 8 bits asinado de &lt;code&gt;&#34;4.5&#34;&lt;/code&gt; mediante &lt;code&gt;RoundingMode.AwayFromZero&lt;/code&gt;.
```powerquery
