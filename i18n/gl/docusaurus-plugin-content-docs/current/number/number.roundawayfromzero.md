...
Devolve o resultado de arredondar `number` baseándose no signo do número. Esta función arredondará os números positivos para arriba e os números negativos para abaixo. Se se especifica `digits`, `number` arredóndase ao número `digits` de díxitos decimais.
