...
Devolve texto con formato que se crea ao aplicar `arguments` dunha lista ou rexistro a unha cadea de formato `formatString`. Tamén se pode fornecer unha `culture` opcional (por exemplo, "gl-ES").
