...
Importe datos de atributos e métricas semanais de Workplace Analytics.


## Examples

### Example #1 
Devolve unha táboa con atributos visibles e métricas por semana para cada empregado medido na partición.
```powerquery
