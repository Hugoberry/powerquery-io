...
Devolve unha táboa de táboas e vistas SQL dunha base de datos Teradata.
...
Devolve unha táboa de táboas e vistas SQL da base de datos Teradata no servidor `server` . O porto pódese especificar opcionalmente co servidor, separado por dous puntos. Pódese especificar un parámetro de rexistro opcional, `options` , para controlar as seguintes opcións:
