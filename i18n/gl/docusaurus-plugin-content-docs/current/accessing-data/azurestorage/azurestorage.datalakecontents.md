...
Devolve o contido do ficheiro no URL, `url`, dun sistema de ficheiros de Azure Data Lake Storage. Pódese especificar `options` para controlar as opcións seguintes:
