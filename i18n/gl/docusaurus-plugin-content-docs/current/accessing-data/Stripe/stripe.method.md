...
Realiza unha chamada á API de Stripe en https://api.stripe.com/v1/`method`, co rexistro `additionalParameters` aprobado como parámetros adicionais e unha lista `ColumnNames` dos nomes de columna esperados. Está a usarse a versión 2015-10-16 de Stripe.
