...
Retorna el resultat d'arrodonir `number` d'acord amb el signe del nombre. Aquesta funció arrodonirà els nombres positius cap amunt i els nombres negatius cap avall. Si s'especifica `digits`, `number` s'arrodoneix al nombre de dígits decimals `digits`.
