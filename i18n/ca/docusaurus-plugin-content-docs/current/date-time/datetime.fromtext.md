...
### Example #1
Converteix `"2010-12-31T01:30:00"` en un valor de datetime.
```powerquery
...
### Example #2
Converteix `"2010-12-31T01:30:00.121212"` en un valor de datetime.
```powerquery
...
### Example #4
Converteix `"20101231T013000"` en un valor de datetime.
```powerquery
