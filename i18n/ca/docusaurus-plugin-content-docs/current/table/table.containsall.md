...
Indica si tots els registres especificats a la llista de registres `rows`, apareixen com a files a la taula `table`. Es pot especificar un paràmetre opcional `equationCriteria` per controlar la comparació entre les files de la taula.
