...
Indica si el registre especificat, `row`, apareix com a fila a la `table`. Es pot especificar un paràmetre opcional `equationCriteria` per controlar la comparació entre les files de la taula.
