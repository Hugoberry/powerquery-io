...
### Example #3
Permet crear una taula que conté el nom, la inicial del segon nom i els cognoms dels clients a partir dels registres especificats. Si falta algun dels valors, substituïu el valor per `null`.
```powerquery
Table.FromRecords({
