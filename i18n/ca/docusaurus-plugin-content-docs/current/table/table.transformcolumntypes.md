...
### Example #1
Transformeu els valors de nombre de la primera columna en valors de text.
```powerquery
let
...
### Example #2
Transforma les dates de la taula en equivalents de text francés.
```powerquery
let
...
### Example #3
Transforma les dates de la taula en equivalents de text alemany i els valors de la taula en percentatges.
```powerquery
let
