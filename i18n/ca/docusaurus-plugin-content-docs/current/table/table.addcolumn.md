...
Afegeix una columna amb el nom `newColumnName` a la taula `table`. Els valors de les columnes es computen mitjançant la funció de selecció especificada `columnGenerator` amb cada fila presa com a entrada.
