...
Retorna una taula a partir de la `table` especificada on el valor de la cel·la següent es propaga a les cel·les de valor nul que hi ha per sobre de la `columns` especificada.
