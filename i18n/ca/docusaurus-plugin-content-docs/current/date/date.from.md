...
### Example #1
Converteix la data i l'hora especificades en un valor de data.
```powerquery
...
### Example #2
Convertiu el número especificat en un valor de data.
```powerquery
Date.From(43910)
```
...
### Example #3
Converteix les dates de text en alemany de la columna Data de publicació a valors de data.
```powerquery
let
