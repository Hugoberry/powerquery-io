...
Importa mètriques setmanals i dades d'atribut del Workplace Analytics.


## Examples

### Example #1 
Retorna una taula amb atributs visibles i mètriques per setmana per a cada empleat mesurat a la partició.
```powerquery
